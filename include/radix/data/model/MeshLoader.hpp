...
public:
  ...
  /**
   * @brief getMesh read mesh file from hard and upload to GPU
   * @param path    mesh file name
   * @return        get refernce to cached file
   */
...
private:
   ...
   * @link https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/glBindBuffer.xhtml
   * @link https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/glBufferData.xhtml
   * @link https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/glVertexAttribPointer.xhtml
   */
